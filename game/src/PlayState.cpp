...
void
PlayState::morrer(cgf::Game* game)
{
}

void
PlayState::handleEvents(cgf::Game* game)
{
...
void
PlayState::update(cgf::Game* game)
{
	screen = game->getScreen();
...
bool
PlayState::checkCollision(uint8_t layer, cgf::Game* game, cgf::Sprite* obj)
{
	int i, x1, x2, y1, y2;
	bool bump = false;
...
sf::Uint16
PlayState::getCellFromMap(uint8_t layernum, float x, float y)
{
